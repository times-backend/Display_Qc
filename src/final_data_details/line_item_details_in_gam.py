...
logger = setup_logger("line_item_Details_in_GAM")
load_dotenv()
...
def get_line_items_details_by_name(client, line_item_name: str) -> List[Dict[str, Any]]:
    ...
    for item in results:
        ...
        if "cpd" in line_item_name.lower():
        ...
        all_line_item_details.append({
            ...
            "priority":priority,
            "targetedAdUnits": targeted_ad_units_name,
            "excludedAdUnits": excluded_ad_units_name,
            "targetedPlacementIds": targeted_placement_names,
            "audience": transformed_audience,
            "day_parting_dates":daypart_run_dates,
...
client=ad_manager.AdManagerClient.LoadFromStorage(NEW_GAM)
#get_line_items_details_by_name(client=ad_manager.AdManagerClient.LoadFromStorage(NEW_GAM), line_item_name="28283440DOMEINFORMTILHOMEINATFCPDNBTRCHPWBWPVNNGDVPMRECPKG215877")
